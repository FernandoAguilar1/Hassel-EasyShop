...
namespace EasyShop.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,quantity,SingleValue,TotalValue")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,quantity,SingleValue,TotalValue")] OrderDetail orderDetail)
        {
